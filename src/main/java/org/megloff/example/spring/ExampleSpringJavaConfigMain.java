...
public class ExampleSpringJavaConfigMain {

	public static void main(String[] args) throws Exception {

		// initialize a logger
		LogManager.getLogManager().readConfiguration(ExampleSpringJavaConfigMain.class.getResourceAsStream("/logger.properties"));
		Logger log = Logger.getLogger(ExampleSpringJavaConfigMain.class.getName());
